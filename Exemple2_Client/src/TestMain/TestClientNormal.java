...
public class TestClientNormal extends Application {
	...
	public void start(Stage primaryStage) {
		...
		send.setOnAction((ActionEvent e) -> {
			...
			try {
				...
				ServClient sc = (ServClient) ctx.lookup("rmi://localhost:1099/ClientImpObject");
				System.out.println("Client start");
				System.out.println("Client finish");
				labelResult.setText("Result : "+ montant +" Dh = "+ sc.echangeDhEr(montant)+" Er ");
